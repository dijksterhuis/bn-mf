...
if (_spawnPointSettings isEqualType "") then {
	_spawnPointSettings = [missionConfigFile >> "map_config" >> "vehicle_spawners" >> "spawn_point_types" >> _spawnPointSettings] call vn_mf_fnc_veh_asset_get_spawn_point_info_from_config;
};
